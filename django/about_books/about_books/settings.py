"""
Django settings for about_books project.
...
SECRET_KEY = 'django-insecure-5*1wf$@s1e3r*bn)_bv59z4*ra#6jqo7@uqg#4s&l0xye(p(e9'
...
WSGI_APPLICATION = 'about_books.wsgi.application'
